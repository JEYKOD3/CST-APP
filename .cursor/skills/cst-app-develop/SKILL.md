...
2. Read [CONTEXT.md](CONTEXT.md) — file map (do not re-explore the whole repo)
...
**Token rule:** Pull facts from project files, not conversation memory. Grep/read targeted paths only.
...
- [ ] 2. Read only files the feature touches
